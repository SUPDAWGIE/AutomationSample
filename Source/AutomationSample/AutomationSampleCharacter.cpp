...
//////////////////////////////////////////////////////////////////////////
// AAutomationSampleCharacter

AAutomationSampleCharacter::AAutomationSampleCharacter()
{
    ...
    InventoryComponent = CreateDefaultSubobject<UTPSInventoryActorComponent>(TEXT("InventoryComponent"));
}

void AAutomationSampleCharacter::BeginPlay()
{
    // Call the base class
    Super::BeginPlay();
...
void AAutomationSampleCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    ...
    if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
    {
        ...
        // Moving
        EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AAutomationSampleCharacter::Move);

        // Looking
        EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AAutomationSampleCharacter::Look);
    }
    else
    {
...
void AAutomationSampleCharacter::Move(const FInputActionValue& Value)
{
    // input is a Vector2D
...
void AAutomationSampleCharacter::Look(const FInputActionValue& Value)
{
    // input is a Vector2D
